...
CASE=docs_grid_rows && want "$@" && run_case "$CASE" "$PY_DOCS/styles" "" "grid_rows.py"
CASE=docs_grid_layout4_row_col_adjust && want "$@" && run_case "$CASE" "$PY_DOCS/guide/layout" "" "grid_layout4_row_col_adjust.py"
CASE=docs_grid_layout_auto && want "$@" && run_case "$CASE" "$PY_DOCS/guide/layout" "" "grid_layout_auto.py"
CASE=docs_column_span && want "$@" && run_case "$CASE" "$PY_DOCS/styles" "" "column_span.py"
CASE=docs_row_span && want "$@" && run_case "$CASE" "$PY_DOCS/styles" "" "row_span.py"
