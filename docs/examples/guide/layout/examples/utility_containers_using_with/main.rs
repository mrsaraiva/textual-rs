/// Port of Python Textual `docs/examples/guide/layout/utility_containers_using_with.py`.
///
/// Demonstrates `Horizontal` and `Vertical` containers with `Static` children
/// laid out in two equal-width columns, each with two rows of content.
